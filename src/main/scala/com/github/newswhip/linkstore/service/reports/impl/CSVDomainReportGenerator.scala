...
class CSVDomainReportGenerator extends ReportGenerator[Map[String, (Int, Long)]] {
  override protected def format(raw: Map[String, (Int, Long)]): List[String] = {
    Constants.CSV_HEADERS :: raw.toList.map(k => k._1 + Constants.CSV_SEPARATOR + k._2._1 + Constants.CSV_SEPARATOR + k._2._2)
  }
